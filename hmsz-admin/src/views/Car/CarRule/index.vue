  ...
  <div class="rule-container">
    ...
    >
        ...
        >
          ...
          <el-form-item label="计费规则">
            ...
            <div v-if="addForm.chargeType === 'duration'" class="duration">
              每
              <el-input v-model="addForm.durationTime" class="input-box" /> 小时
      ...
      <template #footer>
        ...
        <el-button size="mini" type="primary" @click="comfirmAdd"
          >确 定</el-button
        >
      </template>
    </el-dialog>
...
<script>
import { getRuleListAPI, createRuleAPI } from "@/api/carRule";
